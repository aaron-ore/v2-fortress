          ...
          <tbody>
            {forecastData.map((dataPoint, index) => (
              <tr key={index} className="border-b border-gray-200">
                ...
                <td className="py-2 px-4 text-right border-r border-gray-200">{dataPoint["Historical Demand"] > 0 ? dataPoint["Historical Demand"].toLocaleString() : "-"}</td>
                <td className="py-2 px-4 text-right border-r border-gray-200">{dataPoint["Forecasted Demand"] > 0 ? dataPoint["Forecasted Demand"].toLocaleString() : "-"}</td>
                <td className="py-2 px-4 text-right border-r border-gray-200">{dataPoint["Lower Confidence"] > 0 ? dataPoint["Lower Confidence"].toLocaleString() : "-"}</td>
                <td className="py-2 px-4 text-right border-r border-gray-200">{dataPoint["Upper Confidence"] > 0 ? dataPoint["Upper Confidence"].toLocaleString() : "-"}</td>
                <td className="py-2 px-4 text-right">{dataPoint["External Factor (Trend)"] > 0 ? dataPoint["External Factor (Trend)"].toLocaleString() : "-"}</td>
              </tr>
            ))}
          </tbody>
        </table>
