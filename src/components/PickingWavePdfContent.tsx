    ...
    <div className="bg-white text-gray-900 font-sans text-sm p-[20mm]">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="text-right">
          <p className="text-sm font-semibold">PICK DATE: {pickDateObj ? format(pickDateObj, "MMM dd, yyyy") : "N/A"}</p>
      ...
      <div className="text-xs text-gray-500 mt-12 text-right">
        <p>Generated by Fortress on {parseAndValidateDate(pickDate) ? format(parseAndValidateDate(pickDate)!, "MMM dd, yyyy HH:mm") : "N/A"}</p>
      </div>
    </div>
  );
};
