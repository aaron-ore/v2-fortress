...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Attempt to read the raw request body as text first and ONLY this way
    ...
    try {
      ...
      rawRequestBody = 'Error reading body as text.';
      return new Response(JSON.stringify({ error: `Failed to read raw request body: ${readError.message}` }), {
